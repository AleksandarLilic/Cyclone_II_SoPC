...
* note:
***********************************************************************/
void flashsys_init_v1(alt_u32 btn_base, alt_u32 timer_base, status_struct *status)
{
...
void sw_get_command_v1(alt_u32 btn_base, alt_u32 sw_base, status_struct *status)
{
    ...
    if (sw & 0x01)
        status -> sw_alarm_active = 1;
    else
        status -> sw_alarm_active = 0;
...
* argument:
*   *status: struct_status with data with time value
* return:
* note:
***********************************************************************/
...
int main(){
    ...
    // initial settings
    flashsys_init_v1(BTN_BASE, USR_TIMER_BASE, &status);
